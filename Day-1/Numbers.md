# Numbers
Possibilita realizar operações aritméticas.

Além disso, o objeto Math do Javascript traz variados métodos que implementam operações matematicas, simples ou avançadas.
...
// numero aleatorio de 0 a 10 - metodo verboso
